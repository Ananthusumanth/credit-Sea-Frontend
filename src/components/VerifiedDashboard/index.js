...
function VerifiedDashboard(props) {
  ...
  const successView = () => {
    ...
    return (
      <div className='v-container-body'>
        <h1 className='h1'><span className='span'>Dashboard</span>{`> Loan`}</h1>
        <div className='verified-Dashboard'>
          <div className='v-two-dash'>
          ...
          response.verificatiobData.map((each) => (
              <div key={each.id}>
                <div className='nav-v2'>
                  ...
                  <button type='button' className={each.status  === "VERIFIED" ? "action-2" : "action-3"}>{each.status}</button>
        ...
        <div className='nav-symbl-2'>
            ...
            <div>
                <select className='select' onChange={handleChange}>
                    <option value="/Verfied">verifier</option>
      ...
      <div className='verification-section-container'>
        <div className='side-bar-verified'>
            <div className='dash-box'>
              ...
              <p className='para-1'>John Okoh</p>
            </div>
